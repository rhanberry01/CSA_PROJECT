                  ...
                  <Modal isOpen={this.state.modalview} toggle={this.viewModal}
                    ...
                    <Row>
                          <Col>
                            ...
                            {<h6>Payment Reference #: {this.state.tPay.map((tPay, i) => tPay.id+'-')} </h6>}
                            {<h6>Date paid: {this.state.tPay.map((tPay, i) =>  moment(tPay.transaction_date).format('YYYY-MM-DD')+',')} </h6>}
                            {<h6>Amount paid: <IntlProvider locale="en"><FormattedNumber value={this.state.tPay.map((tPay, i) => tPay._net_amount)}/></IntlProvider></h6>}
                          </Col>
                    </Row>
                    </CardBody>
                    </Card>
