    ...
    <Row>
      <Col>           
            <Modal isOpen={this.state.large} toggle={this.openAddModal}
              ...
              <ModalHeader toggle={this.openAddModal}>Cash Receivable from Sales</ModalHeader>
              <ModalBody>
              <Card>
              <CardHeader>
                <strong>Add New Receivable Payment</strong>
              </CardHeader>
              <CardBody>
                ...
                <Row>
                    ...
                    <DatePicker selected={this.state.salesDate} onChange={this.handleSalesDateChange} maxDate={moment()}/> 
                    </FormGroup>
                    </Col>
                    <Col xs="6">
      ...
      <div>
        <Row>
          <Col>
            <Card>
              <CardHeader>
                <i className="fa fa-shopping-cart"></i> Cash Receivable from Sales
              </CardHeader>
              <CardBody>
                <Pagis/>
              </CardBody>
    ...
    if (this.state.toRedirect === true){
      ...
      <div>
        <Modal isOpen={this.state.large} toggle={this.openModal} className={'modal-lg ' + this.props.className}>
                    <ModalHeader toggle={this.openModal}>Payment for Receivables</ModalHeader>
                    <ModalBody>
                    <Card>
                    <CardHeader>
                    ...
                    <CardBody>
                      ...
                      <Row>
                        ...
                        <FormGroup row>
                          <Col md="3">
                            <Label htmlFor="file-input">Proof of Payment:</Label>
                          </Col>
                          <Col xs="12" md="9">
                            <Input type="file" id="depositslip" name="depositslip"/>
                          </Col>
