  ...
  render() {
    if (this.state.toRedirect === true) {
      return (
        <HashRouter>
        <Switch>
          <Route exact path="/sales/dynamic_table" component={() => <MyBody status={true} />}/>
    ...
    <Row>
      <Col>           
      <Button color="success" className="float-right" onClick={this.openModal}><i className="fa fa-plus-square"></i>&nbsp; Record Cash Deposit</Button>
