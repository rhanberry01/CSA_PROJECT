...
//-----START OF TABLE PART
loadDeposits() {
  axios.get('http://192.168.0.188:4001/cashwithdrawal/getdeposit')
    .then(res => {
...
axios.get('http://192.168.0.188:4001/cashwithdrawal/deposittypedropdown')
.then(res => {
...
axios.get('http://192.168.0.188:4001/cashwithdrawal/bankdropdown')
.then(res => {
...
axios.get('http://192.168.0.188:4001/cashwithdrawal/getsalescash', {
params:{ 
...
axios.get('http://192.168.0.188:4001/cashwithdrawal/getsalesdeposited', {
 params:{ 
     remittance_date: moment(date).format('YYYY-MM-DD')
     }
   })
 ...
 axios.get('http://192.168.0.188:4001/cashwithdrawal/getsaleswithdrawal', {
   params:{ 
       remittance_date: moment(date).format('YYYY-MM-DD')
       }
     })
     ...
     const Deposit = {
       ...
       if (a > b) {
        Swal({
         ...
         console.log(Deposit);
         axios.post('http://192.168.0.188:4001/cashwithdrawal/adddeposit', { 
           bal: Deposit.bal,
    ...
    handleSubmit(e) {
      ...
      console.log(a);
        ...
        Swal({
          ...
          if (result.value) {
          axios.put('http://192.168.0.188:4001/cashwithdrawal/updatedeposit', { 
          id: Deposit.id,
          bal: Deposit.bal,
          amount: Deposit.amount,
          memo: Deposit.memo,
  ...
  //==================================================
    ...
    handleDelete(Depositdata) {
      ...
      Swal({
        ...
        if (result.value) {
        //console.log(Deposit);
        axios.delete('http://192.168.0.188:4001/cashwithdrawal/deletedeposit', {
        data:{ 
            id: Deposit.id
          }
        })
    ...
    if (this.state.toRedirect === true){
      ...
      return (
      <div>
        <Modal isOpen={this.state.large} toggle={this.openModal} className={'modal-info ' + this.props.className}>
                    <ModalHeader toggle={this.openModal}>Cash Withdrawal</ModalHeader>
                    <ModalBody>
                    <Card>
                    <CardHeader>
                      <strong>Update Withdrawal</strong>
                    </CardHeader>
                    <CardBody>
